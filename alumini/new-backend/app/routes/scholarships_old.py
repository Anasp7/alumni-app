        ...
        with engine.connect() as conn:
            ...
            for row in result:
                ...
                if current_user["role"] == "student":
                    scholarship["is_eligible"] = check_eligibility(conn, current_user["id"], row)
...
def check_eligibility(conn, user_id, scholarship):
    ...
    try:
        ...
        if scholarship.reservation_category and user.reservation_category:
            if scholarship.reservation_category != "All" and scholarship.reservation_category != user.reservation_category:
                return False
        ...
        if scholarship.eligible_years:
            ...
            if eligible_years and str(user.graduation_year) not in eligible_years:
                return False
        ...
        if scholarship.eligible_majors:
            ...
            if eligible_majors and user.major not in eligible_majors:
                return False
...
def update_scholarship(scholarship_id):
    ...
    try:
        with engine.connect() as conn:
            ...
            if scholarship.posted_by != current_user["id"]:
...
def delete_scholarship(scholarship_id):
    ...
    try:
        with engine.connect() as conn:
            ...
            if current_user["role"] == "alumni" and scholarship.posted_by != current_user["id"]:
...
def apply_scholarship(scholarship_id):
    ...
    try:
        with engine.connect() as conn:
            ...
            # Check eligibility
            if not check_eligibility(conn, current_user["id"], scholarship):
